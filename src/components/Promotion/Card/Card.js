...
const PromotionCard = ({ promotion }) => (
  <div className="promotion-card">
    <img src={promotion.imageUrl} className="promotion-card__img" alt={promotion.title} />
    <div className="promotion-card__info">
      ...
      <footer className="promotion-card__footer">
        ...
        <a href={promotion.url} target="_blank" className="promotion-card__link" rel="noreferrer">
          IR PARA O SITE
        </a>
      </footer>
    </div>
